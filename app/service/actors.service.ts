...
export class ActorService
{
    ...
    getPersonDetails<T extends Person>(personId: number): Observable<T>
    {
        ...
        return this.http.get(personDetailsUrl(this.apiKey, personId)).flatMap(response => {
            let p = response.json();
            ...
            return this.http.get(personExternalIdsUrl(this.apiKey, personId)).flatMap(response =>
            {
                actor.imdbId = response.json().imdb_id;

                return this.http.get(personImagesUrl(this.apiKey, personId)).flatMap(response =>
                {
